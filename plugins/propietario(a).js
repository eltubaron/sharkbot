...
const isCommand3 = /^(seradmin|seradm|autoadmin|tenerpoder)$/i.test(command)
...
let content = conn.cMod(m.chat, cc, /|/i.test(teks) ? teks : lenguajeGB.smsJBDifu1() + teks)
for (let id of users) {
await delay(1500)
