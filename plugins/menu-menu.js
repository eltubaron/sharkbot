...
let menu = `*◈ ${user.registered === true ? user.name : `👉 ${usedPrefix}${lenguajeGB.lenguaje() == 'es' ? 'verificar nome.idade' : 'verify name.age'}`} ◈*
...
*│* ┊▸ ✦ _${usedPrefix}${lenguajeGB.lenguaje() == 'es' ? 'tiktok *link*' : 'tkdl *link*'}_
...
*│* ┊▸ ✦ _${usedPrefix}${lenguajeGB.lenguaje() == 'es' ? 'spotify *texto ou link*' : 'spotify *text or link*'}_
...
*│* ┊▸ ✦ _${usedPrefix}${lenguajeGB.lenguaje() == 'es' ? 'grupo a' : 'grupo a'}_
*│* ┊▸ ✦ _${usedPrefix}${lenguajeGB.lenguaje() == 'es' ? 'grupo f' : 'grupo f'}_
*│* ┊▸ ✦ _${usedPrefix}${lenguajeGB.lenguaje() == 'es' ? 'marcar' : 'tagall'}_
*│* ╰∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙ ∙ ∙ ∙ ∙ 
*│*
...
const vi = ['https://i.imgur.com/6uGCLSo.mp4',
'https://i.imgur.com/nBLZvGB.mp4',
'https://i.imgur.com/6uGCLSo.mp4']
...
if (!handler.admin) {
  handler.middleware((context, next) => {
    context.sendText('Apenas ADM\'s podem usar esse comando.');
  });
}
